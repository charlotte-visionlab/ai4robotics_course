...
input_shape = 784
output_shape = 10
hidden_neurons = [250, 75, output_shape] #Depending on the number of layers in your neural network this is the number of neurons for hidden layer x
...
model = True#Initialize model
optimizer = True#Initialize optimizer
#################################################################################################
