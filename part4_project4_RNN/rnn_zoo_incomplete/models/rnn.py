...
class RNNCell(nn.Module):
    def __init__(self, input_size,
        ...
        ############################################# FOR STUDENTS #####################################
        #Initialize weights for RNN cell (Do not use weight_init or reccurent_weight_init parameters)

        self.W_x = 1 ###### Initialize Input Weight Matrix ######
        self.U_h = 1 ###### Initialize Recurrent Weight Matrix ######
